function mf(unit, model) {
    ...
    createObjectAction1.entity = model.findEntityByQualifiedName(
        "MyFirstModule.Opportunity",
    );
    ...
    memberChange1.attribute = model.findAttributeByQualifiedName(
        "MyFirstModule.Opportunity.OpportunityId",
    );
    ...
    var microflowObjectCollection1 =
        microflows.MicroflowObjectCollection.create(model);
